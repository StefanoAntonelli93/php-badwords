...
<body>
    ...
    <form action="bad_words.php" method='GET'>
        <div>
            <!-- id si lega al for -->
            <label for="bad">Parola da censurare:</label>
            <input type="text" name="bad_word" id="bad">
        </div>
        <div>
            <p><label for="_song_text">textarea:</label></p>
            <textarea id="song_text" name="song_text" rows="30" cols="90">
...
(When they get bit with the—).</textarea>
        </div>
        <div>
            <button>
                Invia!
